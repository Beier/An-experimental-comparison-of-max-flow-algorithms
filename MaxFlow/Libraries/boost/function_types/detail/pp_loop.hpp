...
#include "../../function_types/detail/encoding/def.hpp"
#include "../../function_types/detail/encoding/aliases_def.hpp"

#if defined(BOOST_FT_PREPROCESSING_MODE)
#   define BOOST_FT_loop "../../function_types/detail/pp_cc_loop/master.hpp"
#else
#   define BOOST_FT_loop \
        "../../function_types/detail/pp_cc_loop/preprocessed.hpp"
#endif

#if defined(BOOST_FT_al_path)

#   define BOOST_FT_cc_file \
        "../../function_types/detail/pp_variate_loop/preprocessed.hpp"
#   define BOOST_FT_variate_file \
        "../../function_types/detail/pp_arity_loop.hpp"
...
#include "../../function_types/detail/encoding/aliases_undef.hpp"
#include "../../function_types/detail/encoding/undef.hpp"
