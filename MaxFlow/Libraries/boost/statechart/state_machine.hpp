...
#include "../statechart/null_exception_translator.hpp"
#include "../statechart/result.hpp"

#include "../statechart/detail/rtti_policy.hpp"
#include "../statechart/detail/state_base.hpp"
#include "../statechart/detail/leaf_state.hpp"
#include "../statechart/detail/node_state.hpp"
#include "../statechart/detail/constructor.hpp"
#include "../statechart/detail/avoid_unused_warning.hpp"

#include "../mpl/list.hpp"
#include "../mpl/clear.hpp"
#include "../mpl/if.hpp"
#include "../mpl/at.hpp"
...
#include "../cast.hpp" // boost::polymorphic_downcast
// BOOST_NO_EXCEPTIONS, BOOST_MSVC, BOOST_MSVC_STD_ITERATOR
#include "../config.hpp"

#include "../detail/allocator_utilities.hpp"
