...
#  include "../signals/detail/signal_base.hpp"
#  include "../signals/detail/slot_call_iterator.hpp"
...
#define BOOST_SIGNAL_FUNCTION_N_HEADER BOOST_JOIN("../function/function,BOOST_SIGNALS_NUM_ARGS.hpp")
