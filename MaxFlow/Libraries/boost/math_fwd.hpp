...
//  From "math/special_functions/acosh.hpp"  ---------------------------//

// Only has function template


//  From "math/special_functions/asinh.hpp"  ---------------------------//

// Only has function template


//  From "math/special_functions/atanh.hpp"  ---------------------------//

// Only has function template


//  From "math/special_functions/sinc.hpp"  ----------------------------//

// Only has function templates


//  From "math/special_functions/sinhc.hpp"  ---------------------------//

// Only has function templates


//  From "math/common_factor.hpp"  -------------------------------------//

// Only #includes other headers


//  From "math/common_factor_ct.hpp"  ----------------------------------//
...
//  From "math/common_factor_rt.hpp"  ----------------------------------//
