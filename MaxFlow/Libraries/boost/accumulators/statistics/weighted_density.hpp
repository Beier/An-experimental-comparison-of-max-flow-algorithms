...
#include "../../accumulators/statistics/max.hpp"
#include "../../accumulators/statistics/min.hpp"
#include "../../accumulators/statistics/density.hpp" // for named parameters density_cache_size and density_num_bins
