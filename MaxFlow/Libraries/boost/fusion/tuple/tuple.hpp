...
#include "../../fusion/tuple/tuple_fwd.hpp"
#include "../../fusion/container/vector/vector.hpp"
#include "../../fusion/sequence/intrinsic/size.hpp"
#include "../../fusion/sequence/intrinsic/value_at.hpp"
#include "../../fusion/sequence/intrinsic/at.hpp"
#include "../../fusion/sequence/comparison.hpp"
#include "../../fusion/sequence/io.hpp"
#include "../../utility/enable_if.hpp"
#include "../../type_traits/is_const.hpp"
#include "../../config/no_tr1/utility.hpp"

#if !defined(BOOST_FUSION_DONT_USE_PREPROCESSED_FILES)
#include "../../fusion/tuple/detail/preprocessed/tuple.hpp"
#else
...
namespace boost { namespace fusion
{
    ...
    struct tuple : vector<BOOST_PP_ENUM_PARAMS(FUSION_MAX_VECTOR_SIZE, T)>
    {
        ...
        #include "../../fusion/tuple/detail/tuple_expand.hpp"
