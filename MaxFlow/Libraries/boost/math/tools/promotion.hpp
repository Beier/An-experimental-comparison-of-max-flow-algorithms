...
#include "../../type_traits/is_floating_point.hpp" // for boost::is_floating_point;
#include "../../type_traits/is_integral.hpp" // for boost::is_integral
#include "../../type_traits/is_convertible.hpp" // for boost::is_convertible
#include "../../type_traits/is_same.hpp"// for boost::is_same
#include "../../type_traits/remove_cv.hpp"// for boost::remove_cv
// Boost Template meta programming:
#include "../../mpl/if.hpp" // for boost::mpl::if_c.
#include "../../mpl/and.hpp" // for boost::mpl::if_c.
#include "../../mpl/or.hpp" // for boost::mpl::if_c.
#include "../../mpl/not.hpp" // for boost::mpl::if_c.
