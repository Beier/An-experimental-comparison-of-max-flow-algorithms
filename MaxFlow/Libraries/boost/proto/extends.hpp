...
#include "../proto/expr.hpp"
#include "../proto/args.hpp"
#include "../proto/traits.hpp"
#include "../proto/generate.hpp"
#include "../proto/detail/remove_typename.hpp"
...
namespace boost { namespace proto
{
    ...
    namespace exprns_
    {
        ...
        struct extends
        {
            ...
            #include "../proto/detail/extends_funop_const.hpp"
        };
        ...
        struct extends<Expr, Derived, Domain, 0>
        {
            ...
            // nested preprocessor loops, use file iteration here to generate
            // the operator() overloads, which is more efficient.
            #include "../proto/detail/extends_funop.hpp"
        };
