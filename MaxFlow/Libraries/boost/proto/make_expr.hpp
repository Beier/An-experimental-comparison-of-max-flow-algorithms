...
#include "../proto/detail/poly_function.hpp"
#include "../proto/detail/deprecated.hpp"
...
#define BOOST_PROTO_AS_CHILD(Z, N, DATA)                                                        \
    ...
    namespace detail
    {
        ...
        #include "../proto/detail/unpack_expr_.hpp"

        // Definition of detail::make_expr_
        #include "../proto/detail/make_expr_.hpp"
    }
    ...
    namespace functional
    {
        ...
        struct make_expr
        {
            ...
            #include "../proto/detail/make_expr_funop.hpp"
    ...
    // Additional overloads generated by the preprocessor...
    #include "../proto/detail/make_expr.hpp"
