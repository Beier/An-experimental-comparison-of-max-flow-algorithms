...
namespace boost { namespace proto
{
    namespace detail
    {
        ...
        struct construct_
        {
            ...
            #include "../../proto/transform/detail/construct_funop.hpp"
        };
        ...
        struct construct_<Type, true>
        {
            ...
            // Other overloads generated by the preprocessor
            #include "../../proto/transform/detail/construct_pod_funop.hpp"
        };
    ...
    #include "../../proto/transform/detail/make.hpp"
    #include "../../proto/transform/detail/make_gcc_workaround.hpp"
