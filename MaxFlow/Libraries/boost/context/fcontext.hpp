...
#  include "../context/detail/fcontext_x86_64_win.hpp"
# else
#  include "../context/detail/fcontext_x86_64.hpp"
# endif
// i386
...
# if defined(BOOST_WINDOWS)
#  include "../context/detail/fcontext_i386_win.hpp"
# else
#  include "../context/detail/fcontext_i386.hpp"
# endif
// arm
#elif defined(__arm__) || defined(__thumb__) || defined(__TARGET_ARCH_ARM) \
    || defined(__TARGET_ARCH_THUMB) || defined(_ARM) || defined(_M_ARM)
# include "../context/detail/fcontext_arm.hpp"
// mips
#elif (defined(__mips) && __mips == 1) || defined(_MIPS_ISA_MIPS1) \
    || defined(_R3000)
# include "../context/detail/fcontext_mips.hpp"
// powerpc
...
# include "../context/detail/fcontext_ppc.hpp"
#else
