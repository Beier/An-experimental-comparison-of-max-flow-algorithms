...
#include <new>          
#include "../../config.hpp"  // MSVC, STATIC_CONSTANT, DEDUCED_TYPENAME, DINKUM.
#include "../../cstdint.hpp" // uint*_t
#include "../../detail/workaround.hpp"
#include "../../iostreams/constants.hpp"   // buffer size.
#include "../../iostreams/detail/config/auto_link.hpp"
#include "../../iostreams/detail/config/dyn_link.hpp"
#include "../../iostreams/detail/config/wide_streams.hpp"
#include "../../iostreams/detail/config/zlib.hpp"
#include "../../iostreams/detail/ios.hpp"  // failure, streamsize.
#include "../../iostreams/filter/symmetric.hpp"                
...
#include "../../config/abi_suffix.hpp" // Pops abi_suffix.hpp pragmas.
#ifdef BOOST_MSVC
# pragma warning(pop)
#endif
