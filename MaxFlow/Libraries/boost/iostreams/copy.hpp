...
#include "../config.hpp"                 // Make sure ptrdiff_t is in std.
#include <algorithm>                        // copy, min.
#include <cstddef>                          // ptrdiff_t.
#include <utility>                          // pair.
#include "../bind.hpp"
#include "../detail/workaround.hpp"
#include "../iostreams/chain.hpp"
...
#include "../iostreams/detail/ios.hpp"   // failure, streamsize.                   
#include "../iostreams/detail/resolve.hpp"                   
#include "../iostreams/detail/wrap_unwrap.hpp"
#include "../iostreams/operations.hpp"  // read, write, close.
#include "../iostreams/pipeline.hpp"
