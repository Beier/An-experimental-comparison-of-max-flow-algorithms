...
#include "../../config.hpp"     // for workarounds
#include "../../exception/get_error_info.hpp" // for get_error_info
#include "../../exception/current_exception_cast.hpp" // for current_exception_cast
