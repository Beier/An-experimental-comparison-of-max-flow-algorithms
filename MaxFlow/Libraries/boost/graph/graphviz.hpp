...
#include "../graph/dll_import_export.hpp"
#include "../graph/compressed_sparse_row_graph.hpp"
...
#include "../xpressive/xpressive_static.hpp"
#include "../foreach.hpp"
...
#  endif
#  include "../graph/detail/read_graphviz_spirit.hpp"
#else // New default parser
#  include "../graph/detail/read_graphviz_new.hpp"
...
#  include "../graph/distributed/graphviz.hpp"
#endif
