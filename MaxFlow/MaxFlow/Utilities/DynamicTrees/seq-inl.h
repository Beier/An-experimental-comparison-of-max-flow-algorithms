...
class Search {
 public:
  Search(Node* node, Predicate predicate)
      : node_(node->Expose()), predicate_(predicate) {
  }
 ...
 protected:
  ...
  bool Test(typename Semigroup::Type aggr) { return predicate_(aggr); }
...
template<typename Semigroup, typename Base>
template<typename Node, typename Predicate>
inline Node* WithAggr<Semigroup, Base>::FindLeftmostSeq(Node* node,
                                                        Predicate predicate) {
...
template<typename Semigroup, typename Base>
template<typename Node, typename Predicate>
inline Node* WithAggr<Semigroup, Base>::FindRightmostSeq(Node* node,
                                                         Predicate predicate) {
...
/*template<typename Group, typename Base>
template<typename Node>
inline void WithReverseBy<Group, Base>::ReverseSeq(Node* node) {
